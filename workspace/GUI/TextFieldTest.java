import java.awt.*;
 ...
 textField2 = new JTextField( "Enter text here" );//default string
 container.add( textField2 );

 // construct textfield with default text and
 // 20 visible elements and no event handler
 textField3 = new JTextField( "Uneditable text field", 20 );//string with size
 textField3.setEditable( false );//edit not able with (false)
...
container.add( passwordField );
 ...
 TextFieldHandler handler = new TextFieldHandler();//event for textfield
 ...
 string = "textField1: " + event.getActionCommand();//return string from element that select
